          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            <thead>
              <tr>
                ...
                <th class="center">Status Backup</th>
            ...
            $query = mysqli_query($mysqli, "SELECT * FROM rekaman ORDER BY rekaman_id DESC")
            ...
            while ($data = mysqli_fetch_assoc($query)) { 
              ...
              echo "<tr>
                      ...
                      <td class='center' width='80'>
                        <div>
                          <a data-toggle='tooltip' data-placement='top' title='Download' style='margin-right:5px' class='btn btn-primary btn-sm' download='$data[video]' href='../recording/$data[video]'>
                              <i style='color:#fff' class='glyphicon glyphicon-download-alt'></i>
                          </a>";
            ?>
                        <a data-toggle='tooltip' data-placement='top' title='Detail' style='margin-right:5px' class='btn btn-success btn-sm' href='?module=form_recording&form=detail&id=<?php echo $data['rekaman_id'];?>'>
                              <i style='color:#fff' class='glyphicon glyphicon-list-alt'></i>
                          </a>
                          <a data-toggle="tooltip" data-placement="top" title="Delete" class="btn btn-danger btn-sm" href="modules/recording/proses.php?act=delete&id=<?php echo $data['rekaman_id'];?>" onclick="return confirm('Are you sure you want to delete <?php echo $data['video']; ?> ?');">
